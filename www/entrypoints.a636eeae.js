...
var PlaylistEl = function PlaylistEl(props) {
  ...
  }, _react.default.createElement("h2", null, props.title)), _react.default.createElement("p", {
...
var AlbumEl = function AlbumEl(props) {
  ...
  }, _react.default.createElement("h3", null, props.title)), _react.default.createElement("img", {
    src: props.cover
  }), _react.default.createElement("p", null, _react.default.createElement("b", null, "Year:"), _react.default.createElement("span", null, props.year), _react.default.createElement("br", null), _react.default.createElement("span", null, props.description)), props.children);
};
...
var MediaEl = function MediaEl(props) {
  ...
  }, props.title), _react.default.createElement("p", null, "Author:", props.author), props.type === 'youtube' ? _react.default.createElement("iframe", {
    type: "text/html",
    width: "640",
    height: "390",
...
function (_PureComponent) {
  ...
  function AlbumController(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      description: _album.Album.DEFAULT_DESCRIPTION // handleClick = (event) => {
  ...
  _createClass(AlbumController, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_album_element.AlbumEl, this.state, this.state.tracks.map(function (media, media_index) {
...
},{"react":"SAdv","../utils.js":"JN0q","../models/playlist.js":"rj4B","../views_components/playlist_element.jsx":"zdFj","./album_controller.jsx":"gZVD"}],"h3Gt":[function(require,module,exports) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            render = function render(reactElement) {
              var hook_element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'react_hook';
          ...
          case 3:
            ...
            render(_react.default.createElement(_playlist_controller.PlaylistController, apiIndex));
...
;
main();
},{"react":"SAdv","react-dom":"CSY6","../controllers_containers/playlist_controller.jsx":"rUwH","babel-polyfill":"gepb","_bundle_loader":"PgGh","../../data_fixtures/api_index.json":[["api_index.bc93dae4.js","T4Ih"],"T4Ih"]}],"Awvu":[function(require,module,exports) {
...
//# sourceMappingURL=/entrypoints.6cd23e75.map