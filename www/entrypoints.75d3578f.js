...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"0tLx":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./factoryWithThrowingShims":"632c"}],"rj4B":[function(require,module,exports) {
"use strict";
...
_defineProperty(Playlist, "DEFAULT_TITLE", 'Lista de reproducción sin título');

_defineProperty(Playlist, "DEFAULT_DESCRIPTION", 'Sin descripción :(');
...
},{"prop-types":"yu5W"}],"X7jF":[function(require,module,exports) {

},{}],"zdFj":[function(require,module,exports) {
"use strict";
...
},{"react":"SAdv","../style/playlist.styl":"X7jF"}],"HfQv":[function(require,module,exports) {
...
_defineProperty(Album, "ATTRIBUTE_LIST", ['title', 'description', 'cover', 'year', 'tracks']);

_defineProperty(Album, "DEFAULT_TITLE", 'Album sin título');

_defineProperty(Album, "DEFAULT_DESCRIPTION", 'Sin descripción :(');
...
var _youtube = require("../vendors/youtube.js");
...
var __EVENT_ID_PLAY_TRACKS = Symbol('EVENT_ID_PLAY_TRACKS');
...
function (_PureComponent) {
  ...
  _createClass(PlayerWidgetController, null, [{
    ...
    get: function get() {
      ...
      return !!(__domElementContainer().getAttribute('status') !== _player.PlayerWidget.STATUS_CLOSE.description);
    }
  }]);
  ...
  function PlayerWidgetController(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "$_DOMeventHandlers", {
      $_handleOpenClick: function $_handleOpenClick() {
        _classPrivateFieldGet(_assertThisInitialized(_assertThisInitialized(_this)), _changeStatus).call(_assertThisInitialized(_assertThisInitialized(_this)), _player.PlayerWidget.STATUS_OPEN);
      },
      $_handleMinimizeClick: function $_handleMinimizeClick() {
        _classPrivateFieldGet(_assertThisInitialized(_assertThisInitialized(_this)), _changeStatus).call(_assertThisInitialized(_assertThisInitialized(_this)), _player.PlayerWidget.STATUS_MINIMIZE);
      },
  ...
  _createClass(PlayerWidgetController, [{
    ...
    value: function render() {
      ...
      return (0, _reactDom.createPortal)(_react.default.createElement(_react.default.Fragment, null, this.state.componentDidCatch ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("img", {
        ...
        className: "loading"
      }), _react.default.createElement("h4", null, ":( Algo malo pas\xF3")) : null, this.state.status !== _player.PlayerWidget.STATUS_CLOSE ? _react.default.createElement(_player_widget_element.PlayerWidgetEl, _extends({}, this.state, this.$_DOMeventHandlers), _react.default.createElement("div", {
...
},{"react":"SAdv","../utils.js":"JN0q","../models/album.js":"pghm","../views_components/album_element.jsx":"Yh8S","./media_controller.jsx":"sjfk","./player_widget_controller.jsx":"S9Ar"}],"rUwH":[function(require,module,exports) {
"use strict";
...
function (_PureComponent) {
  ...
  function PlaylistController(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      description: _playlist.Playlist.DEFAULT_DESCRIPTION // handleClick = (event) => {
      // 	console.log(event, this.state.title);
  ...
  _createClass(PlaylistController, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_playlist_element.PlaylistEl, this.state, this.state.albums.map(function (album, album_index) {
...
},{"react":"SAdv","../utils.js":"JN0q","../models/playlist.js":"rj4B","../views_components/playlist_element.jsx":"zdFj","./album_controller.jsx":"gZVD"}],"sP47":[function(require,module,exports) {
module.exports = "/main_logo.35b8ba40.svg";
},{}],"D/S0":[function(require,module,exports) {
"use strict";
...
var IndexLy = function IndexLy(props) {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("header", null), _react.default.createElement("div", {
    ...
    className: "main_logo"
  }), _react.default.createElement("p", null, "A React helloworld"), _react.default.createElement("button", {
    onClick: props.playerShow,
...
},{"react":"SAdv","../../assets/images/main_logo.svg":"sP47","../style/layer.styl":"X7jF"}],"h3Gt":[function(require,module,exports) {
...
},{"core-js/shim":"sy3q","regenerator-runtime/runtime":"dgxz","core-js/fn/regexp/escape":"f086"}],"Ro7T":[function(require,module,exports) {
var bundleURL = null;
...
var _playlist_controller = require("../controllers_containers/playlist_controller.jsx");

var _player_widget_controller = require("../controllers_containers/player_widget_controller.jsx");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            render = function render(reactElement) {
              var hook_element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'react_hook_main';

              _reactDom.default.render(reactElement, document.getElementById(hook_element));
            };
          ...
          case 3:
            apiIndex = _context.sent;
            // console.log('apiIndex', apiIndex, typeof(apiIndex));
            render(_react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_index_layout.IndexLy, {
              playerShow: _player_widget_controller.PlayerWidgetController.show
            }, apiIndex.playlists.map(function (playlist, playlist_index) {
